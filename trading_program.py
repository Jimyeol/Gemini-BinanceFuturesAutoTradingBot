...
class App(ttk.Frame):
    ...
    def setup_widgets(self):
        ...
        self.check_frame = ttk.LabelFrame(self, text="자산 정보", padding=(20, 10))
        self.check_frame.grid(
            row=0, column=0, padx=(20, 10), pady=(20, 10), sticky="nsew"
        )

        self.running = ttk.Label(self.check_frame, text="Running...")
        self.running.grid(row=0, column=0, padx=5, pady=10, sticky="nsew")
        
        self.check_1 = ttk.Label(
            self.check_frame, text="21,432 USDT"
        )
